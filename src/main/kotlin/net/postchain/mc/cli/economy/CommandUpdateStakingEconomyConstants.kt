...
class CommandUpdateStakingEconomyConstants : ECBaseCommand(
    ...
    private val stakingRequirementsSystemProviderOwnStakeUsd by option("--staking-requirements-sp-own", help = "Required provider staking amount in USD for system providers").long()
    private val stakingRequirementsSystemProviderTotalStakeUsd by option("--staking-requirements-sp-total", help = "Required total staking amount in USD for system providers").long()
    private val stakingRequirementsDappProviderOwnStakeUsd by option("--staking-requirements-dp-own", help = "Required provider staking amount in USD for dapp providers").long()
    private val stakingRequirementsDappProviderTotalStakeUsd by option("--staking-requirements-dp-total", help = "Required total staking amount in USD for dapp providers").long()
    ...
    override fun runEC(client: PostchainClient, economyChainClient: PostchainClient) {
        ...
        if (
                listOfNotNull(
                        ...
                        stakingRequirementsSystemProviderOwnStakeUsd,
                        stakingRequirementsSystemProviderTotalStakeUsd,
                        stakingRequirementsDappProviderOwnStakeUsd,
                        stakingRequirementsDappProviderTotalStakeUsd,
                ).isEmpty()
        ) {
