...
class CommandInitEvmEventReceiverTokenChain : PmcCommand(
    ...
    override fun run() {
        ...
        if (version < 75) {
            echo("EVM event receiver token chain requires directory chain version 75, found version $version")
            return
        }
        ...
        eventReceiverConfig?.let {
            ...
            client.transactionBuilder()
                    .initEvmEventReceiverTokenChainOperation(client.pubkey, GtvEncoder.encodeGtv(compressedConfig))
